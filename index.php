        ...
        <div class="row1-of-inst-ads">
            <div class="instad-box">
                <div class="instimage-sec">
                    <?php include 'indexphpcontent/loadimages.php';?>
                </div>
                <div class="inst-det-sec">
                    <?php include 'indexphpcontent/loadcontent1.php';?>
                </div>
            </div>
            <div class="instad-box">
                <div class="instimage-sec">
                    <?php include 'indexphpcontent/loadimages2.php';?>
                </div>
                <div class="inst-det-sec">
                    <?php include 'indexphpcontent/loadcontent2.php';?>
                </div>
            </div>
            <div class="instad-box">
                <div class="instimage-sec">
                    <?php include 'indexphpcontent/loadimages3.php';?>
                </div>
                <div class="inst-det-sec">
                    <?php include 'indexphpcontent/loadcontent3.php';?>
                </div>
            </div>
        </div>
        <script>
            ...
            <div class="row-of-teacher-ad-2">
                <div class="teacher" id="teacher1">
                    <div class="teacher1img">
                        <?php include 'indexphpcontent/teacherimageload.php';?>
                    </div>
                    <div class="techer1-details">
                        <div class="teacher1-name">
                            <span><?php include 'indexphpcontent/teacherdataload.php';?></span>
                        </div>
                        <div class="teacher1-specs">
                            <span><?php include 'indexphpcontent/teacherdataloadsub.php';?></span>
                        </div>
                    </div>
                </div>
                <div class="teacher" id="teacher2">
                    <div class="teacher2img">
                        <?php include 'indexphpcontent/teacherimageload1.php';?>
                    </div>
                    <div class="techer2-details">
                        <div class="teacher2-name">
                            <span><?php include 'indexphpcontent/teacherdataload1.php';?></span>
                        </div>
                        <div class="teacher2-specs">
                            <span><?php include 'indexphpcontent/teacherdataloadsub1.php';?></span>
                        </div>
                    </div>
                </div>
                <div class="teacher" id="teacher3">
                    <div class="teacher3img">
                        <?php include 'indexphpcontent/teacherimageload2.php';?>
                    </div>
                    <div class="techer3-details">
                        <div class="teacher3-name">
                            <span><?php include 'indexphpcontent/teacherdataload2.php';?></span>
                        </div>
                        <div class="teacher3-specs">
                            <span><?php include 'indexphpcontent/teacherdataloadsub2.php';?></span>
                        </div>
                    </div>
                </div>
